...
test('validateToolEvent preserves empty-string payloads for compatible message.part.updated branches', () => {
  const cases = [
    {
      name: 'text branch keeps empty text and delta',
      input: {
        type: 'message.part.updated',
        properties: {
          delta: '',
    ...
    {
      name: 'text branch trims whitespace-only text and delta to empty strings',
      input: {
        type: 'message.part.updated',
        properties: {
          delta: ' \n\t ',
    ...
    {
      name: 'reasoning branch keeps empty text and delta',
      input: {
        type: 'message.part.updated',
        properties: {
          delta: '',
          part: {
            id: 'part-empty-reasoning',
            sessionID: 'tool-gateway-wire',
            messageID: 'msg-gateway-wire',
            type: 'reasoning',
            text: '',
    ...
    {
      name: 'tool branch keeps empty display state fields',
      input: {
        type: 'message.part.updated',
        properties: {
          part: {
