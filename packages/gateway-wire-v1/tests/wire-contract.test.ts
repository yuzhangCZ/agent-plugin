...
import { normalizeDownstream, validateToolEvent, validateUpstreamMessage } from '../src/index.ts';
...
test('validateUpstreamMessage validates transport envelopes and nested tool events', () => {
...
test('validateUpstreamMessage rejects invalid transport payloads', () => {
  const result = validateUpstreamMessage({
