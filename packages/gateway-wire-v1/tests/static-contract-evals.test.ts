...
const toolEventModelPath = resolve(repoRoot, 'packages/gateway-wire-v1/src/contract/literals/tool-event.ts');
const downstreamModelPath = resolve(repoRoot, 'packages/gateway-wire-v1/src/contract/literals/downstream.ts');
const upstreamModelPath = resolve(repoRoot, 'packages/gateway-wire-v1/src/contract/literals/upstream.ts');
const downstreamValidatorDir = resolve(repoRoot, 'packages/gateway-wire-v1/src/adapters/validators');
