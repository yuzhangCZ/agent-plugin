...
- `@wecode/skill-qrcode-auth`: release tag prefix `release/skill-qrcode-auth/v`
- `@wecode/skill-opencode-plugin`: release tag prefix `release/message-bridge/v`
- `@wecode/skill-openclaw-plugin`: release tag prefix `release/message-bridge-openclaw/v`
...
- local release dry-run: `pnpm release:plan -- --target <skill-qrcode-auth|skill-plugin-cli|message-bridge|message-bridge-openclaw|bridge-runtime-sdk> --channel <alpha|beta|release> ...`
- local release execution: `pnpm release:local -- --target <skill-qrcode-auth|skill-plugin-cli|message-bridge|message-bridge-openclaw|bridge-runtime-sdk> --channel <alpha|beta|release> ...`
