...
**Related:** `./validation.md`, `../topics/mb-p0-probe-runtime-connection-race.md`

本文档记录本轮基于 [validation.md](./validation.md) 执行的实际验证结果，以及“手册场景 -> 现有测试”的覆盖映射。
...
- `../topics/mb-p0-probe-runtime-connection-race.md`
