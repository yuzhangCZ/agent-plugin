...
**Related:** `../README.md`, `../operations/usage.md`, `../operations/configuration.md`, `./validation-audit.md`
...
- 安装与联调：`../operations/usage.md`
- 配置字段与优先级：`../operations/configuration.md`
- 实施计划：`../migration/implementation-plan.md`
- 协议时序：`../design/protocol-sequence.md`
- 本轮验证与覆盖审计：`./validation-audit.md`
...
如果你还没完成安装和基础配置，先按 `../operations/usage.md` 执行：
