    ...
    registerHooks({
      resolve(specifier, context, nextResolve) {
        if (specifier === "openclaw/plugin-sdk") {
          return {
            url: "data:text/javascript,export const applyAccountNameToChannelSection = () => {}; export const deleteAccountFromConfigSection = () => {}; export const setAccountEnabledInConfigSection = () => {}; export const buildBaseAccountStatusSnapshot = (input) => ({ ...input.account, ...input.runtime, probe: input.probe ?? null }); export const buildProbeChannelStatusSummary = () => ({}); export const createDefaultChannelRuntimeState = (accountId, state) => ({ accountId, running: false, ...state });",
            shortCircuit: true,
          };
        }
