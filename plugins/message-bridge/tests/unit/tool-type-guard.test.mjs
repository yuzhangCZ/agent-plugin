...
test('known tool types include opencode, openx, uniassistant, codeagent', () => {
  assert.deepEqual(KNOWN_TOOL_TYPES, ['opencode', 'openx', 'uniassistant', 'codeagent']);
  assert.equal(isKnownToolType('opencode'), true);
